    ...
    \definecolor{selectiveyellow}{RGB}{255.0, 186.15, 0.0}
    \definecolor{skobeloff}{RGB}{0.0, 122.39999999999999, 114.75}
    ...
    \begin{tikzpicture}[
        ...
        child [concept color=selectiveyellow]{ node {}
            child { node { }}
            child { node { }}
            child { node { }}
         }
        child [concept color=skobeloff]{ node {}
            child { node { }}
            child { node { }}
            child { node { }}
         }
